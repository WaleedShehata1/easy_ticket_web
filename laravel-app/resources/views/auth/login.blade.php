...
<div class="tab-form00 " id="popup-tab-form">
  <div class="tab-header">  
    ...
    <div class="tab-body00" >
      ...
      <form class="log-in active" action="{{route('login')}}" method="POST">
        @csrf
        <div class="form_input" id="fast">
            <label for="National_ID" >National ID</label>
            <input type="text" name="national_ID" id="National_ID" required>
            @error('national_ID')<p style="width: auto; color: red; margin-bottom:0px;"><b>{{$message}}</b></p>@enderror
          ...
          <div class="form_input">
            ...
            @error('password')<p style="width: auto; color: red; margin-bottom: 0px;"><b>{{$message}}</b></p>@enderror

          </div>

          <div class="remember">
            <a href="{{route('password.request')}}" class="text" id="forgot-password-1">Forgot your password</a>
          </div>
